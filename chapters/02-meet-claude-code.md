...
နောက်ထပ် အာမခံချက်တစ်ခုက **Git**။ Claude ကို အလုပ်တစ်ခုခု စမခိုင်းခင် Commit လုပ်ထားပါ။ Agent က တစ်ခုခုကို ဖရိုဖရဲ လုပ်သွားခဲ့ရင်တောင် (Commit လုပ်ထားပြီးသားဆိုရင်) `git restore .` လို Command တစ်ချက်နဲ့ နောက်ဆုံး Commit အတိုင်း ပြန်ရောက်တယ်။ Git ဆိုတာ Agent ခေတ်ရဲ့ အသက်ကယ်အင်္ကျီ။ မဝတ်ဘဲ ရေထဲမဆင်းပါနဲ့။
