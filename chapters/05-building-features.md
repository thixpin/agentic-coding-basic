...
## အွန်လိုင်းပေါ် တကယ် တင်ခြင်း — Deploy

ခဏနေ ပြန်တွေးမိတယ် — ဒေါ်မြရီကို ပြလိုက်တာက ကျုပ့်ကွန်ပျူတာထဲက `npm run dev` ဖွင့်ထားတဲ့ Screen ကိုပဲ။ ဒါက ကျုပ့်စက်ပေါ်မှာပဲ အလုပ်လုပ်နေတာ (localhost)။ ကျုပ့်ကွန်ပျူတာ ပိတ်လိုက်ရင် ဆိုက်လည်း ပျောက်တယ်။ ဒေါ်မြရီ မူလ ပြောခဲ့တဲ့ "ဖုန်းထဲမှာ ဆိုင်ရှိရတယ်" ဆိုတာ ဆိုလိုတာက **ဆိုင်ရှင်ရော ဝယ်သူပါ** သူတို့ဖုန်း/ကွန်ပျူတာကနေ အချိန်မရွေး ဝင်ကြည့်လို့ရဖို့။ ဒါဆို Website ကို Internet ပေါ် တကယ် Host လုပ်ရမယ်။

"Backend မလို" ဆိုတာ Database တို့ Server Logic တို့ မလိုတာကို ဆိုလိုတာပါ — HTML/CSS/JS ဖိုင်တွေကို လူတိုင်းဖွင့်ကြည့်လို့ရအောင် ထားပေးမယ့် Host တစ်ခုတော့ လိုနေဆဲ။ ဒီလို Static Site အတွက် အခမဲ့ Host လုပ်ပေးတဲ့ ဝန်ဆောင်မှုတွေ (Vercel, Netlify, GitHub Pages) ရှိတယ်။ ဒီစာအုပ်မှာ **Vercel** ကို ဥပမာ သုံးမယ် — Account အခမဲ့ ဖွင့်လို့ရ၊ Command တစ်ကြောင်းတည်းနဲ့ Deploy ပြီးတယ်။

```
> Vercel CLI ကို install လုပ်ပြီး ဒီ project ကို deploy လုပ်ပါ။ Deploy မလုပ်ခင်
> npm run build run ပြီး production build အောင်မြင်ကြောင်း အရင်စစ်ပါ။
```

Claude က `npm install -g vercel`၊ `npm run build`၊ `vercel --prod` စတဲ့ Command တွေ အစီအစဉ်တကျ Run ပေးလိမ့်မယ်။ ပထမဆုံးအကြိမ်ဆိုရင် Vercel Account ထဲ Login ဝင်ခိုင်းလိမ့်မယ် (Email နဲ့ အခမဲ့ Sign Up လုပ်လို့ရတယ်)။ ပြီးရင် ဒီလို Link တစ်ခု ရလာမယ် —

```
https://myaree-store.vercel.app
```

ဒီ Link ကို ဖုန်းထဲက Browser မှာ ဖွင့်ကြည့်ပါ။ ကျုပ့်ကွန်ပျူတာ ပိတ်ထားလည်း ဒီ Link ကတော့ အလုပ်လုပ်နေဆဲ — Internet ရှိတဲ့ တစ်ယောက်ယောက်က ဘယ်နေရာကနေမဆို ဝင်ကြည့်လို့ရပြီ။ ဒါကျမှ "ဖုန်းထဲမှာ ဆိုင်ရှိရတယ်" ဆိုတဲ့ ဒေါ်မြရီ့ တောင်းဆိုချက် တကယ် ပြည့်စုံသွားတာ။

```bash
git add .
git commit -m "deploy ပြီး - v1 live"
```

(Code ပြင်တိုင်း ပြန် Deploy ချင်ရင် `vercel --prod` ကို ပြန် Run ရုံပါပဲ။ Vercel ကို GitHub Repository နဲ့ ချိတ်ထားရင်တော့ Commit တိုင်း အလိုအလျောက် Deploy လုပ်ပေးတဲ့ စနစ်လည်း ရှိတယ် — ဒါကတော့ ဒီစာအုပ်ရဲ့ scope အပြင်ဘက်။)
